...
@unittest.skipIf(True, "Right now not support FP16")
...
@unittest.skipIf(True, "Right now not support INT64")
...
# https://github.com/PaddlePaddle/Paddle/blob/develop/paddle/fluid/operators/reduce_ops/reduce_op.h#L488
@unittest.skipIf(True, "Right now not support FP16")
