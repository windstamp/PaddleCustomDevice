...
void CheckAttrs(bool normalize,
                int ignore_index) {
...
PD_REGISTER_PLUGIN_KERNEL(
    sigmoid_cross_entropy_with_logits, ascend, ALL_LAYOUT, custom_kernel::SigmoidCrossEntropyWithLogitsKernel, float, double) {}

PD_REGISTER_PLUGIN_KERNEL(sigmoid_cross_entropy_with_logits_grad,
                          ascend,
                          ALL_LAYOUT,
