...
template <typename T, typename Context>
void ElementwiseMinGradKernel(const Context& dev_ctx,
                    const phi::DenseTensor& x,
                    const phi::DenseTensor& y,
...
PD_REGISTER_PLUGIN_KERNEL(
    elementwise_min, ascend, ALL_LAYOUT, custom_kernel::ElementwiseMinKernel, float, double) {}

PD_REGISTER_PLUGIN_KERNEL(elementwise_min_grad,
                          ascend,
                          ALL_LAYOUT,
                          custom_kernel::ElementwiseMinGradKernel,
                          float,
                          double) {}
