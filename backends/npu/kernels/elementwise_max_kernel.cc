...
template <typename T, typename Context>
void ElementwiseMaxGradKernel(const Context& dev_ctx,
                    const phi::DenseTensor& x,
                    const phi::DenseTensor& y,
    ...
    NPUAttributeMap attr_input = {{"grad_x", true},
                                             {"grad_y", true}};
    // Reshape info vector.
...
PD_REGISTER_PLUGIN_KERNEL(
    elementwise_max, ascend, ALL_LAYOUT, custom_kernel::ElementwiseMaxKernel, float, double) {}

PD_REGISTER_PLUGIN_KERNEL(elementwise_max_grad,
                          ascend,
                          ALL_LAYOUT,
                          custom_kernel::ElementwiseMaxGradKernel,
                          float,
                          double) {}
